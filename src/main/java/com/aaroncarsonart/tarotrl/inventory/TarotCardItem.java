...
public class TarotCardItem extends Item {
    ...
    private TreeMap<String, AtonementCrystal> atonementCrystals;

    public TarotCardItem(TarotCard card) {
        super(generateCardName(card), generateCardDescription(card));
        this.tarotCard = card;
        this.atonementCrystals = new TreeMap<>();
    }
    ...
    /**
     * Associate an AtonementCrystal with this TarotCard.
     * @param crystal The AtonementCrystal to associate.
     */
    public void addAtonementCrystal(AtonementCrystal crystal) {
        atonementCrystals.put(crystal.getName(), crystal);
    }
}
